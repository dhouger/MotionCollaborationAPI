...
namespace MotionCollaborationAPI.Controllers
{
	public class MotionController : ApiController
	{
		...
		/// <summary>
		/// Returns the default MongoDB database/collection storred in the project settings
		/// </summary>
		...
		{
			return GetMongoCollection<T>(Properties.Settings.Default.DefaultDBName, Properties.Settings.Default.DefaultCollection);
		}
		...
		/// <summary>
		/// Return all of the rules from the default collection/database/MongoClient in the project settings
		/// </summary>
		...
		/// <summary>
		/// Update a MotionModel in the default collection using data from the modelJson
		/// </summary>
		...
		/// <summary>
		/// Add a new record to the default collection using data from modelJson
		/// </summary>
		...
		/// <summary>
		/// Delete a record from the default collection using a provided id string
		/// </summary>
		/// <param name="id"></param>
		/// <returns>A done status or a formatted JSON response</returns>
		[HttpDelete]
